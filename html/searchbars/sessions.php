...
<input type="submit" class="btn btn-warning" name ="send"/>
</form>
</div>
...
<select class="form-control" name="year">
 ...
 <input type="submit" class="btn btn-warning" name ="send"/>
  ...
  <a class="nav-link side-bar-text" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">All Sessions</a>
  <a class="nav-link side-bar-text" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Completed Sessions</a>
  <a class="nav-link side-bar-text" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">Scheduled Sessions</a>
